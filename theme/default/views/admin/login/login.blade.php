...
@section('ariane')
@parent
&nbsp;<span class="icon-custom chevron-right"></span>&nbsp;<a href="{{ asset( 'auth/login' ) }}">{{{ I18n::get('auth.connexion') }}}</a>
@stop
    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <a class="btn btn-default" href="{{URL::to('auth/remind')}}">{{{ I18n::get('auth.forgot_password') }}}</a>
            </div>
        </div>
    </fieldset>
</form>
