<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand favicon" href="{{URL::to('/')}}"><img class="inline-block" src="{{asset('uploads/system/public-favicon/favicon32.png')}}" alt="Logo"> <span>{{ Option::translate('site_name') }}</span></a>
    </div>
    <!-- /.navbar-header -->
