	...
	<div class="form-group {{{ $errors->has('background_position') ? 'has-error' : '' }}}">
		...
		<div class="col-md-10 col-lg-8 switch-container">
		    ...
		    <div class="switch switch-inline">
		        ...
		        <div class="switch-button">
		            <input id="{{$position->name}}" name="background_position" value="background_position" value="{{$position->id}}" class="cmn-toggle cmn-toggle-round-flat" type="radio" {{($page->background->background_position_id==$position->id?'checked="checked"':'')}}>
