 ...
 */
 //ToneDen player
/* Put in @yield('head') for customisability
var createToneDen = function () {	    		
    ToneDen.player.create({
        dom: "#player",
        visualizerType: "waves",
        skin: "dark",
        urls: [
            "https://soundcloud.com/weareharnak"
        ]
    });
}*/
var wait = null;
var toneDenPlayerIsReady = function (callback) {
	if(ToneDen.player){
		//console.log("BIM");    		
		callback();
	} else {
...
//add in queue
console.log('add in queue');
masterClass.addQueue('if(typeof ToneDen !== \'undefined\'){toneDenPlayerIsReady(createToneDen)}');;
/**
 * 
 * Javascript to display on public pages
 *
