...
class Formr extends Eloquent {
        ...
        return array(        
            ...
            'data'  => array(
                'title' => array(
                    ...
                    'title'       => trans('crew::forms.create.blog.inputs.name.title'),
                    'placeholder' => trans('crew::forms.create.blog.inputs.name.placeholder'),
                    'helper'      => trans('crew::forms.create.blog.inputs.name.helper'),
                    'label'       => trans('crew::forms.create.blog.inputs.name.label'),
                ),               
                'description' => array(
                    'name'        => 'description',
                    'type'        => 'textarea',
                    ...
                    'title'       => trans('crew::forms.create.inputs.bio.title'),
                    'placeholder' => trans('crew::forms.create.inputs.bio.placeholder'),
                    'helper'      => trans('crew::forms.create.inputs.bio.helper'),
                    'label'       => trans('crew::forms.create.inputs.bio.label'),
                ),
                'finish_on' => array(
                    'name'        => 'finish_on',
                    'type'        => 'select',
                    ...
                    'title'       => trans('input.gallery.description.title'),
                    'placeholder' => trans('input.gallery.description.placeholder'),
                    'helper'      => trans('input.gallery.description.helper'),
                    'label'       => trans('input.gallery.description.label'),
                ),
                'type' => array(
                    'name'        => 'type',
                    'type'        => 'select',
                ...
                'send' => array(
                    ...
                    'title'       => trans('crew::forms.create.inputs.send.title'),
                    'placeholder' => trans('crew::forms.create.inputs.send.placeholder'),
                    'helper'      => trans('crew::forms.create.inputs.send.helper'),
                    'label'       => trans('crew::forms.create.inputs.send.label'),
                ),
            ),
            'method' => 'model'
        );
	...
	public static function formAction($inputs, $modelId)
    {
        ...
        if (null == $modelId) {
            return Redirect::route('admin.form.show', $form->id)->with('success', trans('forms.create.success'));
        } else {
        	return Redirect::route('admin.form.show', $form->id)->with('success', trans('forms.update.success'));
        }
