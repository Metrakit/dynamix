...
@section('meta_title')
{{{ Lang::get('admin/admin.menu_create') }}} |
@parent
@stop
...
<span class="glyphicon glyphicon-chevron-right"></span>&nbsp;<a href="{{URL::to('admin/menu/create')}}">{{{ Lang::get('admin/admin.menu_create') }}}</a>
@stop


@section('content')
<h2>{{{ Lang::get('admin/admin.menu_create') }}}</h2>
...
<div class="col-sm-9">
{{ Form::open(array('url' => URL::to('admin/menu/create-menu'), 'method' => 'POST', 'class' => 'form-horizontal', 'autocomplete' => 'off' ) ) }}
        <!-- CSRF Token -->
